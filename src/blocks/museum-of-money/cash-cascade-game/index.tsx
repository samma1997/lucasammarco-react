...
const COIN_IMAGE: Record<number, string> = {
  1:  '/blocks/museum-of-money/images/game/coin-1.svg',
  5:  '/blocks/museum-of-money/images/game/coin-5.svg',
  10: '/blocks/museum-of-money/images/game/coin-10.svg',
  25: '/blocks/museum-of-money/images/game/coin-25.svg',
};
...
export default function CashCascadeGame() {
  ...
  const playKaChing = useCallback(() => {
    try {
      if (!audioSourceRef.current) {
        audioSourceRef.current = new Audio('/blocks/museum-of-money/audio/ka-ching.mp3');
  ...
  const spawnCoin = useCallback(() => {
    ...
    const base  = 2.2 + Math.random() * 1.8;
  ...
  // =========================================================================
  // Self-rescheduling spawn scheduler
  // =========================================================================
        ...
        >
          ...
          >
            ...
            >
              <img
                ref={piggyDefaultRef}
                src="/blocks/museum-of-money/images/game/piggy.svg"
                alt="Piggy bank"
                draggable={false}
              ...
              <img
                ref={piggyHappyRef}
                src="/blocks/museum-of-money/images/game/piggy-alt.svg"
              ...
              <img
                ref={piggyMovingRef}
                src="/blocks/museum-of-money/images/game/piggy-walking.svg"
